  ...
  return (
    <div className="mt-16">
      <input
        ...
        accept="image/*"
      />
      <label htmlFor="file-upload" className="flex relative w-full cursor-pointer flex-col items-center justify-center gap-2 border rounded-2xl border-[#F0EFEF] bg-white px-10 py-10 ">
        <div className="absolute inset-1 rounded-xl border border-dashed border-[#F0EFEF]">
        </div>
        <p>Upload file</p>
        <svg
          width="47"
